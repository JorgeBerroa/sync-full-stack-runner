...
export class GithubService {
  ...
  authenticate(token: string): Observable<any> {
    ...
    return this.http
      .get("https://api.github.com/repos/getfyre/fyre-sync", httpOptions)
      .pipe(
        map(() => {
  ...
  getScraperBranches() {
    const url =
      "https://api.github.com/repos/getfyre/fyre-sync-scraper/branches";
    return this.getBranches(url);
  }
  getAdminToolsBranches() {
    const url =
      "https://api.github.com/repos/getfyre/fyre-admin-tools/branches";
    return this.getBranches(url);
  }
